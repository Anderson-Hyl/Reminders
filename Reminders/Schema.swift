...
func appDatabase() throws -> any DatabaseWriter {
	...
	migrator.registerMigration("Create tables") { db in
		...
		migrator.registerMigration("Seed database") { db in
			try db.seed {
				RemindersList(id: 1, color: 0x4a_99_ef_ff, title: "Personal")
				RemindersList(id: 2, color: 0xef_7e_4a_ff, title: "Family")
				RemindersList(id: 3, color: 0x7e_e0_4a_ff, title: "Business")
